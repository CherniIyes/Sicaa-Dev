            ...
            <div id='work' className="my-24">
                  ...
                  <div className="mt-20 flex justify-center items-center flex-wrap">
                        {workInfoData.map((data, index) => (
                              <div
                                    className={`w-72 min-h-96 max-h-96 bg-white p-6 flex flex-col justify-center items-center rounded-2xl m-4 transition-transform duration-300 transform hover:scale-105 ${hoveredIndex !== null && hoveredIndex !== index ? 'scale-90' : ''}`}
                                    key={data.title}
